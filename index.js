...
`).join("");c.insertAdjacentHTML("beforeend",o)}function y(){c.innerHTML=""}const h=document.querySelector(".form");h.addEventListener("submit",L);function L(i){i.preventDefault();const o=i.target.elements["search-text"].value.trim();if(!o){a.error({message:"Empty input, enter a search value!",position:"topRight"});return}d(o).then(({hits:r})=>{y(),r.length===0&&a.error({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight"}),g(r)}).catch(r=>console.log(r))}
